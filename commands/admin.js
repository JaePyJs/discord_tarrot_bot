...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('cleanup')
                .setDescription('Clean old data and logs')
        ),
                ...
                .addFields(
                    {
                        ...
                        value: card.isReversed ? card.reversed.meaning : card.upright.meaning,
                        inline: false
                    },
                    {
                        name: 'Keywords',
                        value: card.isReversed ? card.reversed.keywords.join(', ') : card.upright.keywords.join(', '),
                        inline: true
                    }
                )
                .setThumbnail(card.image_url || null)
                .setFooter({ text: 'Posted by admin • For entertainment purposes only' })
                .setTimestamp();
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    {
                        name: '📊 Analytics',
                        value: process.env.ENABLE_ANALYTICS === 'true' ? '✅ Enabled' : '❌ Disabled',
                        inline: true
                    },
                    {
                        name: '🌅 Daily Cards',
                        value: process.env.DAILY_CARD_ENABLED === 'true' ? '✅ Enabled' : '❌ Disabled',
                        inline: true
                    },
                    {
                        name: '🃏 Total Cards',
