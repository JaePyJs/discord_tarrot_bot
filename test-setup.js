...
async function testSetup() {
    ...
    try {
        ...
        console.log(`✅ Single card reading: ${singleCard[0].name} (${singleCard[0].isReversed ? 'Reversed' : 'Upright'})`);

        const threeCards = cardUtils.threeCardReading();
        console.log(`✅ Three card reading: ${threeCards.map(c => c.name).join(', ')}`);
        ...
        console.log(`✅ Card formatted: ${formattedCard.title}`);

        // Test 4: Load command structure
